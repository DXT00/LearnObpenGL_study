...
namespace BlackPearl {
    ...
    void BasicRenderer::_UploadIndexBuffers(ICommandList* cmdList, BufferGroup* buffers, GraphicsState& state)
    {
        if (!buffers->indexData.empty() && !buffers->indexBuffer)
        {
            ...
            cmdList->setPermanentBufferState(buffers->indexBuffer, res_state);
    ...
    void BasicRenderer::_UploadVertexBuffers(ICommandList* cmdList, BufferGroup* buffers, GraphicsState& state)
    {
        ...
        if (!buffers->vertexBuffer) {
            ...
            cmdList->setPermanentBufferState(buffers->vertexBuffer, state_);
            cmdList->commitBarriers();
    ...
    void BasicRenderer::_UploadInstanceBuffers(ICommandList* cmdList, BufferGroup* buffers, Transform* trans, GraphicsState& state)
    {
        ...
        cmdList->writeBuffer(buffers->instanceBuffer, &buffers->instanceData,
